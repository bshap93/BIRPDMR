...
namespace SingularityGroup.HotReload.Editor
{
    ...
    internal static class EditorCodePatcher
    {
        ...
        static EditorCodePatcher()
        {
            ...
            UnityFieldHelper.Init(Log.Warning, DrawOdinInspectorInfo, OdinPropertyDrawInfo, OdinPropertyDrawPrefixInfo,
                typeof(UnityFieldDrawerPatchHelper));
...
#pragma warning restore CS0612 // Type or member is obsolete
        ...
        private static async Task StartCodePatcher(LoginData loginData = null)
        {
            ...
            try
            {
                ...
                await HotReloadCli
                    .StartAsync(exposeToNetwork, allAssetChanges, disableConsoleWindow, isReleaseMode, loginData)
